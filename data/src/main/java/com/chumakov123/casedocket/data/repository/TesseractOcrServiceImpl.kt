...
class TesseractOcrServiceImpl(
    ...
    override suspend fun recognizeTextInRegion(
        ...
        //println("recognizeTextInRegion: before withContext, thread=${Thread.currentThread().name}")
        return withContext(Dispatchers.Default) {
            mutex.withLock {
                //println("recognizeTextInRegion: inside withContext, thread=${Thread.currentThread().name}")
